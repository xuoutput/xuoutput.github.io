...
# javascript原型, [一文让你理解什么是 JS 原型](https://segmentfault.com/a/1190000017207055)

**对象创建有2种方式, 这里只看通过new+构造函数的方式**.
...
私有属性和非标准属性
> 在js中以`_`开头的属性名为js的**私有属性**，以`__`开头的属性名为非标准属性。`__proto__`是一个非标准属性，最早由`firefox`提出来。
